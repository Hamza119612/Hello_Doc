 ...
 */
final class Version20200622212252 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE specialite CHANGE user_id user_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE rendezvous CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE specialite CHANGE user_id user_id INT DEFAULT NULL, CHANGE slug slug VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
